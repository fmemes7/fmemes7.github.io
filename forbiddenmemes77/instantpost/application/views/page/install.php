...
<div class="row" style="padding-left:15px;padding-right:15px;">
	...
	<h6 class="column-title"><i class="fa fa-cog fa-2x blue"> Install <?php echo $this->config->item('itemShortName');?> Package</i></h6>
  <hr>
  <br>
	<?php 
    ...
    <div class="account-wall" id='recovery_form' style='text-align:left; padding:0 15px;'>
    	<form class="form-material form-horizontal" action="<?php echo site_url().'main/installationAction';?>" method="POST">
        ...
        <div class="form-group">
           ...
           <input type="text" value="<?php echo set_value('database_name'); ?>" name="database_name" required class="form-control ambitious-form-loading col-xs-12"  placeholder="Database Name *">          
        </div>
        
        <div class="form-group">
           <label>Database Username *</label>
           <input type="text" value="<?php echo set_value('database_username'); ?>" name="database_username" required class="form-control ambitious-form-loading col-xs-12"  placeholder="Database Username *">          
        </div>
        <div class="form-group">
         ...
         <div class="form-group">
           <label><?php echo $this->config->item('itemShortName') ?> Admin Panel Login Email*</label>
           <input type="email" value="<?php echo set_value('app_username'); ?>" name="app_username" required class="form-control ambitious-form-loading col-xs-12"  placeholder="Application Username *">          
        </div>
        <div class="form-group">
           <label><?php echo $this->config->item('itemShortName') ?> Admin Panel Login Password *</label>
           <input type="password" name="app_password" required class="form-control ambitious-form-loading col-xs-12"  placeholder="Application Password *">          
        </div>  
