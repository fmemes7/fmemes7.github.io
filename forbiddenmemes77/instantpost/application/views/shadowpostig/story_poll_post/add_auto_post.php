...
<div class="row">
	<div class="col-md-12" style="margin: 0px;padding: 0px;">
      ...
      <div class="panel panel-default block4 block4-header">
        <div class="panel-heading" style="border-bottom:none;"><i class="fa fa-paper-plane"></i> <?php echo $this->lang->line("Story Poll Post");?></div>      
    		<div class="panel-body block42" style="border: none;">
              ...
              <div class="col-md-12">
                <textarea class="form-control ambitious-form-loading" name="message" id="message" rows="5" placeholder="Write a caption..."></textarea>
              </div>
            </div>
            <div class="form-group" style="margin-bottom: 0px">
              <label class="col-md-6" style="margin-bottom: 0px"><?php echo $this->lang->line("Option One");?></label>
              <label class="col-md-6" style="margin-bottom: 0px"><?php echo $this->lang->line("Option Two");?></label>              
            </div>
            <div class="form-group">
              <div class="col-md-6">
                <input class="form-control ambitious-form-loading" name="option_one" id="option_one" type="text"> 
              </div>
              <div class="col-md-6">
                <input class="form-control ambitious-form-loading" name="option_two" id="option_two" type="text"> 
              </div>
            </div>
						<div id="image_block">
							<div class="form-group">
...
<script>
  $("document").ready(function(){
    ...
    $("#video_block,.preview_img_block,.schedule_block_item,.preview_only_img_block").hide();
      ...
      $(document.body).on('change','input[name=schedule_type]',function(){    
        ...
        $("#image_url_upload").uploadFile({
          url:baseUrl+"storypollpost/uploadImageOnly",
          fileName:"myfile",
          returnType: "json",
          dragDrop: true,
          showDelete: true,
          ...
          deleteCallback: function (data, pd) {
              var delete_url="<?php echo site_url('storypollpost/deleteUploadedFile');?>";
          ...
          onSuccess:function(files,data,xhr,pd){
              ...
              var data_modified = "upload/storypollpost/"+data;
      ...
      $("#video_url_upload").uploadFile({
          url:baseUrl+"storypollpost/uploadVideo",
          fileName:"myfile",
      ...
      $("#video_thumb_url_upload").uploadFile({
          url:baseUrl+"storypollpost/uploadVideoThumb",
          fileName:"myfile",
          ...
          onSuccess:function(files,data,xhr,pd){
              var data_modified = baseUrl+"upload/storypollpost/"+data;
      ...
      $(document.body).on('keyup','#message',function(){  
        ...
        $(document.body).on('blur','#link',function(){
          ...
          $.ajax({
              type:'POST' ,
              url:"<?php echo site_url();?>storypollpost/metaInfoGrabber",
              data:{link:link},
              dataType:'JSON',
        ...
        $(document.body).on('blur','#video_url',function(){  
          ...
          if(link!='') {
              $.ajax({
              type:'POST' ,
              url:"<?php echo site_url();?>storypollpost/youtubeVideoGrabber",
              data:{link:link},
              success:function(response){
                 if(response!="") {
                    if(response=='fail') {
        ...
        $(document.body).on('click','#submit_post',function(){          
          ...
          if(post_type=="image_submit") {
            ...
            if($("#option_one").val()=="") {
              alertify.alert('Please give option in option fields');
              return;
            }
            if($("#option_two").val()=="") {
              alertify.alert('Please give option in option fields');
          ...
          $.ajax({
           type:'POST' ,
           url: baseUrl+"storypollpost/addStoryPollPostAction",
           data: queryString,
           dataType : 'JSON',
           cache: false,
           contentType: false,
           ...
           success:function(response) {              
              ...
              var reportLink="<br/><a href='"+baseUrl+"report/storyPost'>See Report</a>";
...
<?php $this->load->view('shadowpostig/story_post/auto_post_css');?>
