...
<div class="row">
	<div class="col-md-12" style="margin: 0px;padding: 0px;">
      ...
      <div class="panel panel-default block4 block4-header">
        <div class="panel-heading" style="border-bottom:none;"><i class="fa fa-paper-plane"></i> <?php echo $this->lang->line("Story Post");?></div>      
    ...
    $("#video_block,.preview_img_block,.schedule_block_item,.preview_only_img_block").hide();
      ...
      $(document.body).on('change','input[name=schedule_type]',function(){    
        ...
        $("#image_url_upload").uploadFile({
          url:baseUrl+"storypost/uploadImageOnly",
          fileName:"myfile",
          returnType: "json",
          dragDrop: true,
          showDelete: true,
          ...
          deleteCallback: function (data, pd) {
              var delete_url="<?php echo site_url('storypost/deleteUploadedFile');?>";
          ...
          onSuccess:function(files,data,xhr,pd){
              ...
              var data_modified = "upload/storypost/"+data;
      ...
      $("#video_url_upload").uploadFile({
          url:baseUrl+"storypost/uploadVideo",
          fileName:"myfile",
      ...
      $("#video_thumb_url_upload").uploadFile({
          url:baseUrl+"storypost/uploadVideoThumb",
          fileName:"myfile",
          ...
          onSuccess:function(files,data,xhr,pd){
              var data_modified = baseUrl+"upload/storypost/"+data;
      ...
      $(document.body).on('keyup','#message',function(){  
        ...
        $(document.body).on('blur','#link',function(){
          ...
          $.ajax({
              type:'POST' ,
              url:"<?php echo site_url();?>storypost/metaInfoGrabber",
              data:{link:link},
              dataType:'JSON',
        ...
        $(document.body).on('blur','#video_url',function(){  
          ...
          if(link!='') {
              $.ajax({
              type:'POST' ,
              url:"<?php echo site_url();?>storypost/youtubeVideoGrabber",
              data:{link:link},
              success:function(response){
                 if(response!="") {
                    if(response=='fail') {
        ...
        $(document.body).on('click','#submit_post',function(){          
          ...
          $.ajax({
           type:'POST' ,
           url: baseUrl+"storypost/addStoryPostAction",
           data: queryString,
           dataType : 'JSON',
           cache: false,
           contentType: false,
