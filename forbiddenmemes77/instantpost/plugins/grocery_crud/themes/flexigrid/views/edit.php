...
<?php 	if(!$this->unset_back_to_list) { ?>
			<input type='button' value='<?php echo $this->l('form_update_changes'); ?>' id="save-and-go-back-button" class="btn btn-lg btn-info btn-outline" style="min-width: 120px;"/>
			<input type='button' value='<?php echo $this->l('form_cancel'); ?>' class="btn btn-lg btn-danger btn-outline" id="cancel-button" style="min-width: 120px;"/>		
<?php 	} ?>
