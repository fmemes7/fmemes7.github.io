...
<div class="flexigrid" style='width: 100%; padding:15px' data-unique-hash="<?php echo $unique_hash; ?>">
	...
	<div class="tDiv">
		<?php if(!$unset_add){?>
		<div class="tDiv2">
        	<a href='<?php echo $add_url?>' title='<?php echo $this->l('list_add'); ?> <?php echo $subject?>' class='btn btn-info btn-outline' style="min-width: 100px;">							
			...
			<div class="form-group">
				...
				<select name="search_field" id="search_field" class="form-control" style='min-width:150px;max-width:300px;'>					
					...
					{ 
						...
						continue;
						?>
						<option <?php if($count_search_field==1) echo 'selected="yes"';?> value="<?php echo $column->field_name?>">Search by: <?php echo $column->display_as?>&nbsp;&nbsp;</option>
